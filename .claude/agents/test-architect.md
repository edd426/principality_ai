...
tools: Glob, Grep, Read, WebFetch, TodoWrite, WebSearch, BashOutput, KillShell, mcp__ide__getDiagnostics, mcp__ide__executeCode, Edit, Write, NotebookEdit, SlashCommand
model: inherit
color: yellow
---
